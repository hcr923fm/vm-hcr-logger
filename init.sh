...
sudo apt-get install -y build-essential dkms alsa-tools libasound2-dev libasound2 alsa-base alsa-utils git automake ncurses-dev pkg-config libsndfile-dev libmp3lame-dev unattended-upgrades ntp
